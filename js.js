...
// Ocultar elementos que não correspondem ao critério de filtragem
document.querySelectorAll('.item').forEach(function (elemento) {
    console.log(elemento)
    if (!atendeCriterio(elemento)) {
        elemento.style.display = 'none';
    }
});

// Função de exemplo para determinar se um elemento atende ao critério de filtragem
function atendeCriterio(elemento) {
    // Implemente sua lógica de filtragem aqui
    return true; // Exemplo: mostrar todos os elementos
}
